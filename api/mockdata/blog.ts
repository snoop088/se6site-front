...
export const BLOG_POSTS_FULL: BlogItem[] = [
  {
    ...
    copyMd:
      ...
      "  \n\n - Takeover skins are generally static, but it is possible to create dynamic ones with tools like [StreamEye](/features). They also are generally created to take advantage of full HD resolution (1920x1080), placing important elements such as ad offers or hero graphics in safe zones to ensure they look good on any type of desktop screen." +
